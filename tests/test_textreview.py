from text_review.get_collection import *
from text_review.kodex import *
from text_review.marksearch import marksearch
from text_review.model import get_engtokor
from text_review.utils import *
...
def test_review(input_date):
    # global pretrained_model_path
    date_list = get_date_range(input_date)
